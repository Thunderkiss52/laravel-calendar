<?php
namespace Thunderkiss52\LaravelCalendar;
...
class CalendarProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        $package
            ...
            ->hasConfigFile()
            ->hasMigrations([
                'create_calendar_tasks_table'
            ])
            ->hasRoute('calendar')
            ->hasInertiaComponents()
            ->publishesServiceProvider('CalendarProvider')
